...
<rapid:override name="content">
    ...
    <form name="post" method="post" id="insertDraftForm"
          class="initial-form hide-if-no-js" action="/admin/subway/insertSubway">

        <div class="layui-form-item">
            <label class="layui-form-label">线路名称  <span style="color: #FF5722; ">*</span></label>
            <div class="layui-input-block">
                <input type="text" name="subwayName" id="subwayName" required  lay-verify="required" placeholder="地铁线路" autocomplete="off" class="layui-input" required>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="time" name="endTimeShow" id="endTimeShow" required  lay-verify="required" placeholder="结束时间" autocomplete="off" class="layui-input" required>
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea name="subwayRemark" placeholder="请输入内容" id="subwayRemark" class="layui-textarea" required></textarea>
            </div>
        </div>
